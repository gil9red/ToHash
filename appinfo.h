...
#define VER_FILEDESCRIPTION_STR     "ToHash"
#define VER_INTERNALNAME_STR        "ToHash"
#define VER_ORIGINALFILENAME_STR    "ToHash.exe"
#define VER_PRODUCTNAME_STR         "ToHash"
#define VER_COMMENTS                "The program hashes the text"
